                                            ...
                                            return Container(
                                              ...
                                              child: InkWell(
                                                onTap: () {
                                                  ...
                                                  //               dropoff: bookride[i]
                                                  //                   ['drop_location'],
                                                  //               totalamount: bookride[i]
                                                  //                   ['total_amount'],
                                                  //               date: bookride[i]
                                                  //                   ['rdate'],
                                                  //               ridestatus: bookride[i]
                                                  //                   ['ride_type'],
                                                  //               vehicle: bookride[i]
                                                  //                   ['vehicle'],
                                                  //               distance: bookride[i]
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              currentDate.toString() ==
                                                                  ...
                                                                  : (yesterdayDate
                                                                              .toString() ==
                                                                          DateFormat(bookride[ii]['rdate'].toString().substring(0, 10))
                                                                              .format(now)
                                                                      ? Text(
                                                              ...
                                                              // Text(
                                                              //   'Today ${bookride[i]['rdate'].toString().substring(11, 19)} \n${bookride[i]['vehicle']}',
                                                              //   style: TextStyle(
                                                              //       fontWeight:
                                                              //           FontWeight
                                                              //               .w700),
