...
class VehicleFitnessScreen extends StatefulWidget {
  @override
  VehicleFitnessState createState() => VehicleFitnessState();
}

class VehicleFitnessState extends State<VehicleFitnessScreen> {
  File _image;
  File _backImage;
  var loading = false;
  ...
  upload(var context) async {
    ...
    var request = http.MultipartRequest(
      "POST",
      Uri.parse(vehicleFitnessUploadUrl),
    );
    ...
    var frontImage =
        await http.MultipartFile.fromPath("vehicle_fitness_1", _image.path);
