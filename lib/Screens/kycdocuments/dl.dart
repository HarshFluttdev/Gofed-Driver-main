...
import '../home/DcoumentAndTrainingScreen.dart';

class DLScreen extends StatefulWidget {
  @override
  DLState createState() => DLState();
}

class DLState extends State<DLScreen> {
  File _image;
  File _backImage;
  var loading = false;
  ...
  upload(var context) async {
    ...
    await upl.asyncSingleFileUpload(id, 'driving', _image.path);
