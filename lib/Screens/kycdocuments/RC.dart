...
import 'package:quicksewadriver/Screens/kycdocuments/PollutionScreen.dart';
...
class RCScreen extends StatefulWidget {
  @override
  RCScreenState createState() => RCScreenState();
}

class RCScreenState extends State<RCScreen> {
  File _image;
  File _backImage;
  var loading = false;
  ...
  upload(var context) async {
    ...
    await upl.asyncSingleFileUpload(id, 'rc', _image.path);
