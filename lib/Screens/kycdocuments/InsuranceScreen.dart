...
import 'package:quicksewadriver/Screens/kycdocuments/VehicleFitness.dart';
...
class InsuranceState extends State<InsuranceScreen> {
  File _image;
  File _backImage;
  var loading = false;
  ...
  upload(var context) async {
    ...
    await upl.asyncSingleFileUpload(id, 'insurance', _image.path);
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return VehicleFitnessScreen();
    }));
