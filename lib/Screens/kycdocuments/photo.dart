...
class _DocumentUploadScreenState extends State<DocumentUploadScreen> {
  ...
  upload(var context) async {
    ...
    await upl.asyncMultipleFileUpload(
        id, 'aadhar_front', 'aadhar_back', _image.path, _backImage.path);
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        _showBackSideImagePicker(context);
                      },
                      child: Container(
                        height: height * 0.15,
                        width: width * 0.3,
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      if (_image == null || _backImage == null) {
