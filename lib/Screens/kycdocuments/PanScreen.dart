...
import 'package:quicksewadriver/Screens/kycdocuments/InsuranceScreen.dart';
...
class PanScreen extends StatefulWidget {
  @override
  PanScreenState createState() => PanScreenState();
}

class PanScreenState extends State<PanScreen> {
  File _image;
  File _backImage;
  var loading = false;
  ...
  upload(var context) async {
    ...
    await upl.asyncSingleFileUpload(id, 'pan', _image.path);
